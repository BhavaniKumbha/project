 ...
 */
package com.gofortrainings.project.core.models;
...
import com.gofortrainings.project.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "project/components/helloworld");
